      ...
      <section className="relative min-h-[90vh] flex items-center">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <p className="text-accent font-semibold text-lg mb-4 animate-fade-in">
              Логистическая компания
            </p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground mb-6 leading-tight animate-fade-in">
              Объединенная <br />
              <span className="text-accent">Служба Логистики</span>
            </h1>
            <p className="text-xl text-primary-foreground/90 mb-8 leading-relaxed animate-fade-in">
